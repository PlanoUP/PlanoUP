import { MaterialCriticality } from "@/lib/brava/materials/types";
import { MATERIAL_CRITICALITY_META } from "@/lib/brava/materials/meta";
import { cn } from "@/lib/brava/cn";

export default function MaterialCriticalityBadge({
  criticality,
  size = "md",
  className,
}: {
  ...
  const meta = MATERIAL_CRITICALITY_META[criticality];
  return (
    <span
      className={cn(
